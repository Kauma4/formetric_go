    ...
    return func(c *gin.Context) {
        ...
        if question.IsTest {
            ...
            if question.MultipleAnswers {
                ...
                if !hasCorrectAnswer {
                    c.JSON(http.StatusBadRequest, gin.H{"error": "Для вопроса с множественными ответами нужен хотя бы один правильный ответ"})
                    return
                }
            }
            ...
            question.MultipleAnswers = false // Сбрасываем для нетестовых вопросов
        }
